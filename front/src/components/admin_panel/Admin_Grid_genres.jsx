...
import { Box, ButtonGroup, CardActionArea, CardActions, Divider, Fab } from "@mui/material";
            ...
            <Card sx={{ maxWidth: 150, maxHeight: 280 }} >
              <CardActionArea>
                ...
                <ButtonGroup size='small' fullWidth >
                  <DeleteForeverRoundedIcon color='error' onClick={()=>{handlerRemove(genre.id,genre.genre,i)}}  />
                  <Divider position='vertical' />
            <EditRoundedIcon color='primary' onClick={()=>{genreHandler(genre.id,i)}} />
        </ButtonGroup>
