...
const UserData = () => {
    ...
    const handleChanges = ()=>{
        axios
            .put(`http://localhost:3001/api/users/${user.id}`, {firstName, lastName, age})
            .then((res)=>{
            ...
            <Box>
                <List>
                    <Stack direction="row" justifyContent="center" alignItems="center" spacing={12}>
                        <Typography>FirstName:</Typography><Item>{user.firstName}</Item><TextField onChange={handleFirstName}></TextField>
                    </Stack>
                    <br/>
                    <Stack direction="row" justifyContent="center" alignItems="center" spacing={12}>
                    <Typography>LastName:</Typography><Item>{user.lastName}</Item><TextField onChange={handleLastName}></TextField>
                    </Stack>
                    <br/>
                    <Stack direction="row" justifyContent="center" alignItems="center" spacing={12}>
                    <Typography>Age:</Typography><Item>{user.age}</Item><TextField onChange={handleAge}></TextField>
                    </Stack>
                    <br/>
                    <Stack><Button onClick={handleChanges}>Make Changes</Button></Stack>
                </List>
            </Box>
        </>
    )
